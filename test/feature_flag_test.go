...
func TestFeatureFlagWithCache(t *testing.T) {
	createContextMyApp(t, "my-app", nil,
		[]*service.DefinitionGlobal{
			registry.ServiceProviderErrorLogger(),
			registry.ServiceProviderClock(),
			registry.ServiceProviderFeatureFlagWithCache(initFeatures),
		},
		nil,
	)
...
func TestFeatureFlagWithMysqlAndCache(t *testing.T) {
	createContextMyApp(t, "my-app", nil,
		[]*service.DefinitionGlobal{
			registry.ServiceProviderErrorLogger(),
			registry.ServiceProviderClock(),
			registry.ServiceProviderFeatureFlagWithMysql(initFeatures),
		},
		nil,
	)

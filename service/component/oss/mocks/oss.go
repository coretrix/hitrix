...
func (t *FakeOSSClient) UploadObjectFromFile(_ *datalayer.ORM, namespace oss.Namespace, localFile string) (entity.FileObject, error) {
...
func (t *FakeOSSClient) UploadImageFromFile(_ *datalayer.ORM, namespace oss.Namespace, localFile string) (entity.FileObject, error) {
	return t.Called(namespace, localFile).Get(0).(entity.FileObject), nil
}

func (t *FakeOSSClient) UploadImageFromBase64(_ *datalayer.ORM, namespace oss.Namespace, image, extension string) (entity.FileObject, error) {
...
func (t *FakeOSSClient) CreateObjectFromKey(_ *datalayer.ORM, namespace oss.Namespace, key string) entity.FileObject {
